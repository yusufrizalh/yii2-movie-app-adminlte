...
(3, 'Perempuan Tanah Jahanam', 'Maya (Tarao Basro) berusaha bertahan di kota tanpa keluarga. Hanya sahabat baiknya Dini (Marissa Anita), yang bersama dirinya jatuh bangun mencoba memperbaiki hidup. Ketika Maya mendapatkan informasi bahwa dia mungkin memiliki harta warisan dari keluarga Maya yang kaya di sebuah desa, Maya dan Dini langsung ke sana tanpa menyadari bahaya yang menanti.', '', '', '7', 0, ''),
(4, 'Susi Susanti: Love All', 'Susi Susanti (Laura Basuki) sudah jadi sensasi bulutangkis pada usia 14 tahun dan berkembang menjadi atlet paling dicintai di Indonesia. Di bawah bimbingan pelatihnya, Liang Chiu Sia (Jenny Chang) dan didorong oleh janji kepada ayahnya, Susi berhasil mendapatkan pengakuan Internasional karena memenangkan medali emas Olimpiade pertama untuk Indonesia.', '', '', '6.8', 0, ''),
...
(15, 'The Expendable 3', '', 'Action', '', '8.9', NULL, ''),
(16, 'Pengabdi Setan', NULL, 'Horor', NULL, '8.6', NULL, NULL),
(17, 'Suzzanna: Bernapas dalam Kubur', NULL, 'Horor', NULL, '7.4', NULL, NULL),
(18, 'Si Doel The Movie', NULL, 'Drama', NULL, '6.7', NULL, NULL),
(19, 'Rampage', NULL, 'Action', NULL, '8.1', NULL, NULL),
(20, 'Robin Hood', NULL, 'Action', NULL, '8.7', NULL, NULL),
(21, 'Alpha', NULL, 'Action', NULL, '3.7', NULL, NULL),
(22, 'Venom', NULL, 'Action', NULL, '9', NULL, NULL),
(23, 'Deadpool 2', NULL, 'Action', NULL, '9.3', NULL, NULL),
(24, 'Predator', NULL, 'Action', NULL, '8.2', NULL, NULL),
(25, 'Ant-Man and the Wasp', 'Ant-Man and the Wasp merupakan film ke-20 keluaran MCU, berdasarkan karakter superhero dari komik Marvel Scott Lang / Ant-Man dan Hope van Dyne / Wasp karya Stan Lee, Larry Lieber, Jack Kirby, dan Wasp.', 'Action', '', '8.7', NULL, 'Ant-Man-and-the-Wasp-700x467.jpg'),
(26, 'SKYSCRAPER', 'Skyscraper merupakan film laga Amerika yang disutradarai oleh Rawson Marshall Thurber, dan dibintangi salah satunya oleh Dwayne Johnson sebagai Will Sawyer. Film ini mengisahkan tentang mantan agen FBI (Will Sawyer) yang harus menyelamatkan keluarganya dari gedung pencakar langit tertinggi di dunia yang baru dibangun, namun dibakar dan diambil alih oleh para penjahat.', 'Action', '', '7.6', NULL, 'Skyscrapper-700x514.jpg'),
(27, 'OCEAN’S 8', 'Ocean’s 8 merupakan film komedi bertema perampokan yang merupakan kelanjutan serta spin-off dari trilogi Steven Soderbergh’s Ocean.\r\n\r\nFilm yang ditulis oleh Ross dan Olivia Milch ini mengisahkan tentang sekelompok wanita yang dipimpin oleh saudara perempuan dari Danny Ocean (Debbie Ocean) yang diperankan oleh Sandra Bullock. Ia merencanakan pencurian canggih pada Gala Met tahunan di Metropolitan Museum of Art New York.', 'Drama Komedi', '', '7.5', NULL, 'Oceans-8-700x445.jpg');
...
(4, 'inixsby', 'Inixindo2019', '', '1991-07-15', 'Laki-Laki', 'Surabaya', NULL),
(5, 'user test 1', 'Test2019', '', '0000-00-00', 'Perempuan', 'Malang', NULL),
(6, 'user test 2', 'Test2019', '', '0000-00-00', 'Perempuan', 'Surabaya', NULL);
